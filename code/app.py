...
# Use the same intents.json file that was used for training
intents_path = os.path.join(script_dir, "..", "..", "dataset-20250827T134237Z-1-001", "dataset", "intents.json")
with open(intents_path, encoding="utf-8") as file:
    data = json.load(file)

model_data = torch.load(os.path.join(script_dir, "data.pth"))
...
def get_response():
    ...
    # Initialize responses with a default fallback
